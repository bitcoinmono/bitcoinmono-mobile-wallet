...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    KEY_OUTPUT = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/KeyOutput"));
    ...
    RAW_TRANSACTION = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/RawTransaction"));
    RAW_TRANSACTION_CONST = env->GetMethodID(RAW_TRANSACTION, "<init>", "([Lbtcmzapp/semipool/com/KeyOutput;Ljava/lang/String;Ljava/lang/String;)V");
    RAW_TRANSACTION_KEY_OUTPUTS = env->GetFieldID(RAW_TRANSACTION, "keyOutputs", "[Lbtcmzapp/semipool/com/KeyOutput;");
    ...
    WALLET_BLOCK_INFO = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/WalletBlockInfo"));
    WALLET_BLOCK_INFO_CONST = env->GetMethodID(WALLET_BLOCK_INFO, "<init>", "(Lbtcmzapp/semipool/com/RawTransaction;[Lbtcmzapp/semipool/com/RawTransaction;)V");
    WALLET_BLOCK_INFO_COINBASE_TRANSACTION = env->GetFieldID(WALLET_BLOCK_INFO, "coinbaseTransaction", "Lbtcmzapp/semipool/com/RawTransaction;");
    WALLET_BLOCK_INFO_TRANSACTIONS = env->GetFieldID(WALLET_BLOCK_INFO, "transactions", "[Lbtcmzapp/semipool/com/RawTransaction;");

    TRANSACTION_INPUT = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/TransactionInput"));
    ...
    SPEND_KEY = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/SpendKey"));
    ...
    INPUT_MAP = (jclass) env->NewGlobalRef(env->FindClass("btcmzapp/semipool/com/InputMap"));
    INPUT_MAP_CONST = env->GetMethodID(INPUT_MAP, "<init>", "(Ljava/lang/String;Lbtcmzapp/semipool/com/TransactionInput;)V");
    INPUT_MAP_PUBLIC_SPEND_KEY = env->GetFieldID(INPUT_MAP, "publicSpendKey", "Ljava/lang/String;");
    INPUT_MAP_TRANSACTION_INPUT = env->GetFieldID(INPUT_MAP, "input", "Lbtcmzapp/semipool/com/TransactionInput;");
...
Java_btcmzapp_semipool_com_TurtleCoinModule_processBlockOutputsJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_btcmzapp_semipool_com_TurtleCoinModule_generateRingSignaturesJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_btcmzapp_semipool_com_TurtleCoinModule_checkRingSignatureJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_btcmzapp_semipool_com_TurtleCoinModule_generateKeyDerivationJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_btcmzapp_semipool_com_TurtleCoinModule_generateKeyImageJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_btcmzapp_semipool_com_TurtleCoinModule_deriveSecretKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
...
extern "C" JNIEXPORT jstring JNICALL
Java_btcmzapp_semipool_com_TurtleCoinModule_derivePublicKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
